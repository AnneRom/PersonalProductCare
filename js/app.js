(() => {
    ...
    let slidersStore = {};
    function initResponsiveSlider({sliderId, wrapperSelector, slideSelector, widthBreakpoint = 800, slidesPerView = 1, storeKey}) {
        ...
        if (isMobile && !storedSlider) {
            ...
            slidersStore[storeKey] = new swiper_core_Swiper(swiperEl, {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        window.addEventListener("resize", (() => {
            ...
            } else sideMenu.classList.remove("no-transition");
        }));
        window.addEventListener("scroll", (() => {
            let scrollTop = window.scrollY || document.documentElement.scrollTop;
            if (scrollTop > lastScrollTop && scrollTop > header.offsetHeight) header.classList.add("hidden"); else header.classList.remove("hidden");
